...
public class BoardController {
	...
	public BoardController () {
		...
		try {
			Scanner fileOne = new Scanner (new File("../Thats-Life/src/Config/PlayerOne.txt"));
			Scanner fileTwo = new Scanner (new File("../Thats-Life/src/Config/PlayerTwo.txt"));
			Scanner fileThree = new Scanner (new File("../Thats-Life/src/Config/PlayerThree.txt"));
