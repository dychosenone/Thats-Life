...
//INITIALIZING FUNCTIONS / GAME STARTING FUNCTIONS
	...
	public void enterPlayers (int numofPlayers) {
		...
		do {
			...
			}while (temp.equalsIgnoreCase("null"));
	...
	public int getNumberOfPlayers() {
		...
		System.out.println("getNumberOfPlayers entered");
		...
		do {
			...
			if (num >= MINPLAYERS && num <= MAXPLAYERS) {
				...
				ui.displayText("INVALID INPUT, ONLY 2 TO 3 PLAYERS ARE ALLOWED");
			}
		...
		System.out.println(num + "players will be created");
